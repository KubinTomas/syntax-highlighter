...
{
    public class JavaTokenFilter : ISHFilter
    {
        ...
        public JavaTokenFilter(AbstractTokenRecognizer tokenRecognizer)
        {
        ...
        private List<Token> FixIdentifiers(List<Token> separatedSource)
        {
            ...
            {
                if (token.Text == "import") usingIsProccessed = true;
                if (token.Text == ";") usingIsProccessed = false;

                if (token.Text == "package") namespaceIsProccessed = true;
        ...
        private void CheckOrReplaceClassOrNsIdentifier(Token currentToken)
        {
            ...
            if (previousToken.Text == "package" || previousToken.Text == "import") currentToken.ChangeTokenType(TokenType.IDENTIFIER_NS);
        }
        ...
        //IDENTIFIER_NS, // jméno jmenného prostoru v konstrukcích import  a package 
